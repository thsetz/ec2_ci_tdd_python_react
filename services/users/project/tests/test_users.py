...
class TestUserService(BaseTestCase):
    ...
    def test_add_user_via_rest(self):
        """Ensure a new user can be added to the database."""
        self.add_admin('test', 'test@test.com', 'test')
        with self.client:
    ...
    def test_single_user(self):
        ...
        user = add_user("michael", "michael@mherman.org", "passw")
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user("michael", "michael@mherman.org", "passw")
        add_user("fletcher", "fletcher@notreal.com", "passw")
        with self.client:
    ...
    def test_main_add_user(self):
        """ Ensure a new user can be added to the database via a
            POST request.  """
        with self.client:
            response = self.client.post(
                "/",
                data=dict(
                    username="michael", email="michael@sonotreal.com", password="pass"
                ),
